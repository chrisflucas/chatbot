...
class Chatbot:
    ...
    def process(self, input):
      ...
      throwing this error so you see my comment
      '''
      ALEX READ THIS COMMENT
      when we get to this point, normally we have stripped titles of the years.
      however, if there are multiple makes of the movie, then we have to distinguish by the year
      so the year is now added to the movie title -- but only in this case.
      '''
      ...
      self.add_to_vector(movie.strip(), sentiment)
